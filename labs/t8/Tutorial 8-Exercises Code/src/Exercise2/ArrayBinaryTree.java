 ...
 * Binary Tree's nodes are indexed using the numbering scheme introduced in Lecture.
 * Node has a string label that is stored in the l array.
 * Please refers to Lecture and tutorial instruction for more detail on Binary Tree's ADT.
 * @author (nxthang) 
 * @version (1.0)
 */
